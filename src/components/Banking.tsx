...
export default function Banking() {
  return (
    <div className="CustomContainer flex flex-col px-3 lg:px-0 sm:flex-row  items-center justify-center md:items-end md:justify-evenly text-white bg-[#5BB5A2] mt-25 rounded-2xl">
