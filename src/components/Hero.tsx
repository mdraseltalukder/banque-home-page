...
export default function Hero() {
  return (
    <div className="bg-[#e8f2ee] dark:bg-background">
      <div className="CustomContainer flex flex-col px-3 lg:px-0 gap-3 items-center text-center justify-center pt-[60px] lg:pt-[128px] ">
        <h1 className="heading1">All in one card.</h1>
        <h4 className="heading4">
          Senectus et netus et malesuada fames ac turpis. <br /> Sagittis vitae
          et leo duis ut diam.
        </h4>
        <div className="flex items-center gap-2 md:gap-6 mt-6 mb-[65px] lg:mb-[152px]">
